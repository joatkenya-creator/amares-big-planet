...
const articleDrafts = [
  ...
  },
  {
    ...
    videoId: "0HwOpDwVXak",
    videoTitle: "ABC Songs for Preschool Kids",
    readingTime: "4 min read",
  ...
  },
  {
    ...
    videoId: "AEvh5oJCkWM",
    videoTitle: "Screen Time Learning Activities for Kids",
    readingTime: "4 min read",
...
const mondayToSundayArticle: Article = {
  ...
  description: "Hop aboard the Galaxy Train and sing your way through every day of the week! Amar\u00e9 and the Gear Crew make learning Monday to Sunday an unforgettable adventure.",
  excerpt: "Hop aboard the Galaxy Train and sing your way through every day of the week! Amar\u00e9 and the Gear Crew make learning Monday to Sunday an unforgettable adventure.",
  category: "Music & Learning",
  videoId: "L-ggtCPoRjM",
  videoTitle: "A Magical Monday to Sunday Adventure | Days of the Week Song",
  readingTime: "4 min read",
  readTime: "4 min read",
  ...
  keywords: [
    ...
    "monday to sunday song",
    "days of the week for toddlers",
    "weekly calendar song for kids",
    "children learning songs",
    "learning days of the week",
  ],
  intro: "Days of the week are one of the earliest and most useful concepts young children learn \u2014 and one of the trickiest to make stick. Seven abstract words in a fixed order, with no obvious visual clues, can feel like a lot for little minds. That\u2019s exactly why Amar\u00e9 and the Gear Crew created this song.",
  sections: [
    {
      heading: "Why learning the days of the week matters",
      body: "Understanding the days of the week builds a child\u2019s sense of time, routine, and sequencing \u2014 all foundational skills for maths, literacy, and social development. When a child knows that Tuesday comes after Monday, they are practising the same logical ordering they\u2019ll later use for numbers, the alphabet, and even story structure.",
    },
    {
      heading: "The magic of music for memory",
      body: "Music turns repetition into play. The same child who struggles to recall a list of seven words after ten readings will often nail all seven days after hearing a catchy song just twice. Melody and rhythm act as memory scaffolding \u2014 the tune becomes a retrieval cue that makes the words easier to recall.",
    },
    {
      heading: "How to use this song at home",
      body: "Watch it together every morning and say the current day out loud before pressing play. Pause after each day and ask: \u201cWhat comes next?\u201d Use a simple weekly chart on the fridge and move a sticker each morning to the correct day. After a week, try singing it without the video \u2014 you\u2019ll be amazed how fast they remember.",
    },
  ],
  learningGoals: [
    "Days of the week",
  ...
  parentTip: "Make a \u2018Day of the Week\u2019 ritual. Each morning, ask your child to find today on the chart, say it out loud, and sing the song together before breakfast. After two weeks it will be completely automatic \u2014 and they\u2019ll feel incredibly proud.",
  body: "",
};
