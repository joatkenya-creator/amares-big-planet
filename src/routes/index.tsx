    ...
    <div className="min-h-screen overflow-hidden bg-background">
      ...
      <footer className="bg-[var(--primary)] text-[var(--primary-foreground)] pt-12 pb-6 border-t-4 border-[var(--sunshine)]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-6 grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-3.5 max-w-xs sm:max-w-none mx-auto">
            ...
            <a href="https://www.roblox.com/share?code=c2c98ee6659b1c48aaffb9f3efb3fe87&type=ExperienceDetails&stamp=1778764599349" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#010101] text-white text-sm font-semibold px-5 py-2.5 hover:opacity-90 transition-all">
